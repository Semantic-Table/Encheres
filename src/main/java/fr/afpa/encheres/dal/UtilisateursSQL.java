...
public class UtilisateursSQL {
    public ArrayList<Utilisateurs> selectAll() {
        ...
        try (Connection connection = ConnectionProvider.getConnection(); PreparedStatement pstmt = connection.prepareStatement("SELECT no_utilisateur, pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mot_de_passe, credit, administrateur,actif FROM utilisateurs");){
    ...
    public Utilisateurs selectByPseudo(String pseudo) {
        ...
        try (Connection connection = ConnectionProvider.getConnection(); PreparedStatement pstmt = connection.prepareStatement("SELECT no_utilisateur, pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mot_de_passe, credit, administrateur,actif FROM utilisateurs WHERE pseudo = ?");){
    ...
    public Utilisateurs selectByEmail(String email) {
        Utilisateurs utilisateurs = null;
        try (Connection connection = ConnectionProvider.getConnection(); PreparedStatement pstmt = connection.prepareStatement("SELECT no_utilisateur, pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mot_de_passe, credit, administrateur,actif FROM utilisateurs WHERE email = ?");){
...
if (utilisateurs.getPseudo().equals("") || utilisateurs.getPseudo() == null ||
    ...
    throw new ChampVideException("Un champ n'a pas été rempli");
            ...
            try (Connection connection = ConnectionProvider.getConnection(); PreparedStatement pstmt = connection.prepareStatement("INSERT INTO utilisateurs(pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mot_de_passe, credit, administrateur, actif) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");){
    ...
    public void update(int no_utilisateurs, Utilisateurs utilisateurs) throws ChampVideException {
        if (utilisateurs.getPseudo().equals("") || utilisateurs.getPseudo() == null ||
            ...
            try (Connection connection = ConnectionProvider.getConnection(); PreparedStatement pstmt = connection.prepareStatement("UPDATE utilisateurs SET pseudo = ? , nom = ? , prenom = ? , email = ? , telephone = ? , rue = ? , code_postal = ? , ville = ? , mot_de_passe = ? , credit = ? , administrateur = ?, actif = ? WHERE no_utilisateur = ?");){
                pstmt.setString(1, utilisateurs.getPseudo());
                pstmt.setString(2, utilisateurs.getNom());
                pstmt.setString(3, utilisateurs.getPrenom());
                pstmt.setString(4, utilisateurs.getEmail());
    ...
    public void delete(int no_utilisateur) {
        try (Connection connection = ConnectionProvider.getConnection(); PreparedStatement pstmt = connection.prepareStatement("DELETE FROM utilisateurs WHERE no_utilisateur = ?");){
    ...
    public Utilisateurs selectById(int no_utilisateurs) {
        Utilisateurs utilisateurs = null;
        try (Connection connection = ConnectionProvider.getConnection(); PreparedStatement pstmt = connection.prepareStatement("SELECT no_utilisateur, pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mot_de_passe, credit, administrateur,actif FROM utilisateurs WHERE no_utilisateur = ?");){
    ...
    public Utilisateurs selectByLast() {
        Utilisateurs utilisateurs = null;
        try (Connection connection = ConnectionProvider.getConnection(); PreparedStatement pstmt = connection.prepareStatement("SELECT no_utilisateur, pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mot_de_passe, credit, administrateur,actif FROM utilisateurs ORDER BY no_utilisateur DESC LIMIT 1");){
            ResultSet rs = pstmt.executeQuery();
            while (rs.next()) {
                utilisateurs = new Utilisateurs(rs.getInt("no_utilisateur"), rs.getString("pseudo"), rs.getString("nom"), rs.getString("prenom"), rs.getString("email"), rs.getString("telephone"), rs.getString("rue"), rs.getString("code_postal"), rs.getString("ville"), rs.getString("mot_de_passe"), rs.getInt("credit"), rs.getBoolean("administrateur"), rs.getBoolean("actif"));
            }
    ...
    public Utilisateurs selectByPseudoAndByMot_de_passe(String pseudo, String mot_de_passe) {
        Utilisateurs utilisateurs = null;
        try (Connection connection = ConnectionProvider.getConnection(); PreparedStatement pstmt = connection.prepareStatement("SELECT no_utilisateur, pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mot_de_passe, credit, administrateur, actif FROM utilisateurs WHERE pseudo = ? AND mot_de_passe = ?");){
            pstmt.setString(1, pseudo);
